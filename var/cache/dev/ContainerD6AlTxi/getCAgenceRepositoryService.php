 ...
 */
class getCAgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CAgenceRepository' shared autowired service.
     *
     * @return \App\Repository\CAgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CAgenceRepository.php';

        return $container->privates['App\\Repository\\CAgenceRepository'] = new \App\Repository\CAgenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
